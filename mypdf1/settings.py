...
SECRET_KEY = 'django-insecure-hol)x2g*rptg_m3=&d+%_vxcbwt9yk!k2u-qne_73(scjl5x(i'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://prateek:ozmSZsZGGiS5NnbCtlo2FyGC7NcQLUpg@dpg-d0vf8rmmcj7s73ejdo10-a.oregon-postgres.render.com/dbresgen',
        conn_max_age=600,
        ssl_require=True
    )
}
...
LOGOUT_REDIRECT_URL = 'welcome'  # Where to redirect after logout
...
PDFKIT_CONFIG = {
    'wkhtmltopdf': '/usr/local/bin/wkhtmltopdf'  # Update this path
}
...
# For development (your local static files)
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Remove if directory doesn't exist
]
